...
<div class="rest-container">
    ...
    <div class="address-title">Manage Partners</div>
    ...
    <div class="sign-up-form-container">
        <div class="width-100">
            ...
            <div class="border-bottom-primary ">
                <a href="/partnersreg" class="home-options-list href-decoration-none">
            ...
            <!--Driver Registration Item Start-->
            <div class="border-bottom-primary">
                <a href="/allpartner" class="home-options-list href-decoration-none">
                    All Partners
                    <span class="fas fa-check icon chosen hidden"></span>
                    <span class="icon choose float-right">
                        <img src="{{asset('mobstyle/icons/angle-right.svg')}}" alt="Angle Right Icon">
