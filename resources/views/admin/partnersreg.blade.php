                    ...
                    <div class="card-number">
                        ...
                        <div class="form-group">
                            <label class="width-100">
                                <span class="label-title">Name Of Business</span>
                                <span class="car-info-wrap display-block">
                                    <input class="form-control text-input font-weight-light" placeholder="Company Name" type="text" autocomplete="off" name="fname">
                        ...
                        <div class="form-group">
                            <label class="width-100">
                                <span class="label-title">Company Registration Number</span>
                                <span class="car-info-wrap display-block">
                                    <input class="form-control text-input font-weight-light" type="text" placeholder="Registration Number" autocomplete="off" name="nin">
